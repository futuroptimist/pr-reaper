...
test('close-my-open-prs workflow defaults and forwards external contribution protection', () => {
  ...
  assert.match(
    workflowSource,
    /include_external_contributions: \$\{\{ inputs\.include_external_contributions \}\}/
  );
});
