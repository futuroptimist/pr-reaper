...
test('workflow safely defaults and forwards external contribution input', () => {
  ...
  assert.match(workflowSource, /include_external_contributions: \$\{\{ inputs\.include_external_contributions \}\}/);
});
